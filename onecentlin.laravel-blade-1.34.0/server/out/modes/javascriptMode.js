...
var JQUERY_D_TS = (0, path_1.join)(__dirname, '../../lib/jquery.d.ts');
var JS_WORD_REGEX = /(-?\d*\.\d\w*)|([^\`\~\!\@\#\%\^\&\*\(\)\-\=\+\[\{\]\}\\\|\;\:\'\"\,\.\<\>\/\?\s]+)/g;
function getJavascriptMode(documentRegions) {
    var jsDocuments = (0, languageModelCache_1.getLanguageModelCache)(10, 60, function (document) { return documentRegions.get(document).getEmbeddedDocument('javascript'); });
    ...
    return {
        ...
        doComplete: function (document, position) {
            ...
            var replaceRange = convertRange(currentTextDocument, (0, strings_1.getWordAtText)(currentTextDocument.getText(), offset, JS_WORD_REGEX));
            return {
                isIncomplete: false,
