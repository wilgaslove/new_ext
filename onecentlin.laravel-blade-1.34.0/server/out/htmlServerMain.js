...
var connection = (0, vscode_languageserver_1.createConnection)();
...
connection.onInitialize(function (params) {
    ...
    var capabilities = {
        ...
        completionProvider: clientSnippetSupport ? { resolveProvider: true, triggerCharacters: __spreadArray(__spreadArray([], emmetTriggerCharacters, true), ['.', ':', '<', '"', '=', '/'], false) } : undefined,
        hoverProvider: true,
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    modes_1.forEach(function (mode) {
                        if (mode.doValidation && isValidationEnabled(mode.getId(), settings_1)) {
                            (0, arrays_1.pushAll)(diagnostics_1, mode.doValidation(textDocument, settings_1));
                        }
                    });
                    _a.label = 2;
                case 2:
                ...
                case 3:
                    e_1 = _a.sent();
                    connection.console.error((0, errors_1.formatError)("Error while validating ".concat(textDocument.uri), e_1));
                    return [3 /*break*/, 4];
...
connection.onCompletion(function (textDocumentPosition) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, (0, errors_1.runSafe)(function () { return __awaiter(void 0, void 0, void 0, function () {
                var document, mode, result_1, emmetCompletionList, emmetCompletionParticipant, settings, result;
                var _a;
                    ...
                    switch (_b.label) {
                        case 0:
                            ...
                            if (cachedCompletionList
                                ...
                                result_1 = (0, vscode_emmet_helper_1.doComplete)(document, textDocumentPosition.position, mode.getId(), emmetSettings);
                            ...
                            if (mode.setCompletionParticipants) {
                                emmetCompletionParticipant = (0, vscode_emmet_helper_1.getEmmetCompletionParticipants)(document, textDocumentPosition.position, mode.getId(), emmetSettings, emmetCompletionList);
                        ...
                        case 1:
                            ...
                            if (emmetCompletionList && emmetCompletionList.items) {
                                ...
                                return [2 /*return*/, { isIncomplete: true, items: __spreadArray(__spreadArray([], emmetCompletionList.items, true), result.items, true) }];
                            }
                            return [2 /*return*/, result];
                    }
                });
            }); }, null, "Error while computing completions for ".concat(textDocumentPosition.textDocument.uri))];
    });
}); });
connection.onCompletionResolve(function (item) {
    return (0, errors_1.runSafe)(function () {
        var data = item.data;
...
connection.onHover(function (textDocumentPosition) {
    return (0, errors_1.runSafe)(function () {
        ...
        return null;
    }, null, "Error while computing hover for ".concat(textDocumentPosition.textDocument.uri));
});
connection.onDocumentHighlight(function (documentHighlightParams) {
    return (0, errors_1.runSafe)(function () {
        ...
        return [];
    }, [], "Error while computing document highlights for ".concat(documentHighlightParams.textDocument.uri));
});
connection.onDefinition(function (definitionParams) {
    return (0, errors_1.runSafe)(function () {
        ...
        return [];
    }, null, "Error while computing definitions for ".concat(definitionParams.textDocument.uri));
});
connection.onReferences(function (referenceParams) {
    return (0, errors_1.runSafe)(function () {
        ...
        return [];
    }, [], "Error while computing references for ".concat(referenceParams.textDocument.uri));
});
connection.onSignatureHelp(function (signatureHelpParms) {
    return (0, errors_1.runSafe)(function () {
        ...
        return null;
    }, null, "Error while computing signature help for ".concat(signatureHelpParms.textDocument.uri));
});
connection.onDocumentRangeFormatting(function (formatParams) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, (0, errors_1.runSafe)(function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, (0, formatting_1.format)(languageModes, document, formatParams.range, formatParams.options, settings, enabledModes)];
                    }
                });
            }); }, [], "Error while formatting range for ".concat(formatParams.textDocument.uri))];
    });
}); });
connection.onDocumentLinks(function (documentLinkParam) {
    return (0, errors_1.runSafe)(function () {
        ...
        var links = [];
        if (document) {
            var documentContext_2 = (0, documentContext_1.getDocumentContext)(document.uri, workspaceFolders);
            languageModes.getAllModesInDocument(document).forEach(function (m) {
                if (m.findDocumentLinks) {
                    (0, arrays_1.pushAll)(links, m.findDocumentLinks(document, documentContext_2));
                }
            });
        }
        return links;
    }, [], "Error while document links for ".concat(documentLinkParam.textDocument.uri));
});
connection.onDocumentSymbol(function (documentSymbolParms) {
    return (0, errors_1.runSafe)(function () {
        ...
        return symbols;
    }, [], "Error while computing document symbols for ".concat(documentSymbolParms.textDocument.uri));
});
connection.onRequest(protocol_colorProvider_proposed_1.DocumentColorRequest.type, function (params) {
    return (0, errors_1.runSafe)(function () {
        ...
        return infos;
    }, [], "Error while computing document colors for ".concat(params.textDocument.uri));
});
connection.onRequest(protocol_colorProvider_proposed_1.ColorPresentationRequest.type, function (params) {
    return (0, errors_1.runSafe)(function () {
        ...
        return [];
    }, [], "Error while computing color presentations for ".concat(params.textDocument.uri));
});
connection.onRequest(TagCloseRequest.type, function (params) {
    return (0, errors_1.runSafe)(function () {
        ...
        return null;
    }, null, "Error while computing tag close actions for ".concat(params.textDocument.uri));
});
