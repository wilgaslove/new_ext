"use strict";(self.webpackChunkhttp_workbench=self.webpackChunkhttp_workbench||[]).push([[7623],{17623:(e,l,n)=>{n.r(l),n.d(l,{FileUploader:()=>Pe,KeyValueEditor:()=>mn});var i=n(7560),t=n(40540),o=n(25892),s=n.n(o),a=n(62932),r=n(50916),d=n(98283),c=n(64382),u=n(22723),h=n.n(u),p=n(53723),b=n.n(p),v=n(80519),g=n(52322);let f,m,x=e=>e;const y=s().div(f||(f=x`
  position: relative;
  display: flex;
...
`),(e=>e.isLastColumn?`0 1 ${e.columnWidth}%`:`0 0 ${e.columnWidth}%`),(({isLastColumn:e})=>e?"unset":"var(--border-width-default) var(--border-style-solid)\n    var(--border-color-default)"),(e=>e.isNonEditable?"var(--background-color-secondary)":"inherit"),(e=>e.isNonEditable?"var(--content-color-secondary)":"inherit"));function S(e){let{content:l}=e,n=(0,d.Z)(e,k);return(0,g.jsx)(V,(0,i.Z)({},n,{children:l}))}const T=e=>e?e.charAt(0).toUpperCase()+e.slice(1):"";function E(e,l){if(typeof e!=typeof l)return!1;const n=typeof e;return["string","number","boolean","undefined"].includes(typeof e)?e===l:Array.isArray(e)&&Array.isArray(l)?e.length===l.length&&e.every(((e,n)=>E(e,l[n]))):"object"===n&&(null===e&&null===l||null!==e&&null!==l&&!Array.isArray(e)&&!Array.isArray(l)&&Object.keys(e).length===Object.keys(l).length&&Object.keys(e).every((n=>E(e[n],l[n]))))}var R=n(59713);let D;const A=s().div(D||(D=(e=>e)`
  align-items: center;
  height: 24px;
  display: inline-flex;
...
`));function Z({onClick:e}){return(0,g.jsx)(A,{className:"delete-button",onClick:e,role:"button","aria-label":"delete-row",children:(0,g.jsx)(R.Z,{})})}function W(e,l,n){let i,t,o,s,a,r,d=0,c=!1,u=!1,h=!0;if("function"!=typeof e)throw new TypeError("Expected a function");if(l=+l||0,n&&function(e){const l=typeof e;return null!=e&&("object"===l||"function"===l)}(n)){if(c=!(null==n||!n.leading),u="maxWait"in n,u){const e=(null==n?void 0:n.maxWait)||0;o=Math.max(+e,l)}h="trailing"in n?!(null==n||!n.trailing):h}function p(l){const n=i,o=t;return i=t=void 0,d=l,s=e.apply(o,n),s}function b(e,l){return setTimeout(e,l)}function v(e){const n=e-r;return void 0===r||n>=l||n<0||u&&e-d>=o}function g(){const e=Date.now();if(v(e))return f(e);a=b(g,function(e){const n=e-d,i=l-(e-r);return u?Math.min(i,o-n):i}(e))}function f(e){return a=void 0,h&&i?p(e):(i=t=void 0,s)}function m(...e){const n=Date.now(),o=v(n);if(i=e,t=this,r=n,o){if(void 0===a)return function(e){return d=e,a=b(g,l),c?p(e):s}(r);if(u)return a=b(g,l),p(r)}return void 0===a&&(a=b(g,l)),s}return m.cancel=function(){void 0!==a&&clearTimeout(a),d=0,i=r=t=a=void 0},m.flush=function(){return void 0===a?s:f(Date.now())},m.pending=function(){return void 0!==a},m}const M=["indicators","isDuplicated"];let F,P,O=e=>e;const z=s().textarea(F||(F=O`
  width: 100%;
  ...
  ${0}
`),(({isDuplicated:e})=>e&&"padding-right: var(--spacing-l)")),$=s().div(P||(P=O`
  display: flex;
...
`),(e=>e.isDisabled?"var(--content-color-tertiary)":"var(--content-color-primary)"),(e=>e.isDisabled?"not-allowed":"pointer"),(e=>!e.isDisabled&&"border-color: var(--button-outline-hover-border-color)")),Me=s()(we.Z)(Ee||(Ee=De`
  max-width: 100%;
`)),Fe=s().div(Re||(Re=De`
  width: 100%;
  span {
...
`));function Pe(e){return(0,g.jsx)(Ce.VW,{children:(0,g.jsx)(Oe,(0,i.Z)({},e))})}function Oe(e){const{value:l,onReset:n,id:o,label:s,name:a,multiple:r,isDisabled:c,loading:u,error:h,accept:p,autoFocus:b,onChange:v}=e,f=(0,d.Z)(e,Ve),{addToast:m}=(0,Ce.ZP)();let x;if((0,t.useEffect)((()=>{h&&m({status:"error",title:Ae,description:h})}),[h,m]),null!=l&&l.length){const e=l.length,i=l[0],t=l.join(", "),o=e>1?`${e} files selected`:`${i}`;x=(0,g.jsx)(oe.Z,{content:t,children:(0,g.jsx)(Fe,{children:(0,g.jsx)(ke.Af,{label:o,onClick:n})})})}else x=(0,g.jsxs)(g.Fragment,{children:[(0,g.jsx)(Ze,(0,i.Z)({},f,{id:o,onChange:e=>{const l=e.target,n=l&&l.files;!c&&n&&(null==v||v(n))},multiple:r,disabled:c,accept:p,name:a,autoFocus:b,onClick:e=>{e.currentTarget.value=""}})),(0,g.jsxs)(We,{htmlFor:o,isDisabled:c,children:[u&&(0,g.jsx)(je.Z,{size:"small"}),(0,g.jsx)("span",{children:s})]})]});return(0,g.jsx)(Me,{direction:"column",alignItems:"center",children:x})}const ze=()=>{const e=(0,t.useRef)(!0);return(0,t.useEffect)((()=>()=>{e.current=!1}),[]),e};let $e;const Ne="Select Files",Be=s()(we.Z)($e||($e=(e=>e)`
  padding: var(--spacing-xs);
`));function He(e){const{id:l,type:n,value:i,hidden:o,error:s,onFilesSelect:a,onChange:r}=e,[d,c]=(0,t.useState)(!1),u=ze(),h=(0,t.useMemo)((()=>Array.isArray(i)?i:i?[i]:[]),[i]);return o?null:(0,g.jsx)(Be,{height:"100%",width:"100%",children:(0,g.jsx)(Pe,{label:Ne,id:"key-value-file-uploader",multiple:!0,error:s,value:h,loading:d,onChange:e=>{a&&(c(!0),a(l,e).finally((()=>{u.current&&c(!1)})))},onReset:()=>null==r?void 0:r(n,"")})})}const Le=e=>e.disableEdit,Ke=(e,l)=>l||e.system&&!e.allowedToToggle,Ie=(e,l)=>!e.disableEdit&&!(null!=l&&l.disableToggle)||e.system;var _e=n(70262),Ue=n(95362);let Xe;const Ye=s().div(Xe||(Xe=(e=>e)`
...
`),(({enableScroll:e})=>e&&"overflow: overlay;"));function Rl(e){let{values:l,disableSorting:n,onChange:o,onRemove:s,disableDelete:a,disableCreate:r,disableToggle:c,keyPlaceholder:u,valuePlaceholder:h,descriptionPlaceholder:p,disableVariableRowDropdown:b,currentWidth:v,maskStatesMap:f,toggleMaskValue:m,onPersist:x,onReset:y,onBlur:w,filteredIndices:C,searchValue:k,enableScroll:j,duplicateWarningsMap:V}=e,S=(0,d.Z)(e,Sl);const T=(0,t.useCallback)(((e,l)=>{o&&o(e,l)}),[o]),E=(0,t.useCallback)((e=>{s&&s(e)}),[s]),R=k&&C?C.map((e=>l[e])):l;return(0,g.jsx)(El,{enableScroll:j,children:k&&0===R.length?(0,g.jsx)("div",{className:"key-value-form-editor-sortable",children:(0,g.jsx)(jl.Z,{title:"No results found",children:(0,g.jsx)(Vl.Z,{name:"illustration-search"})})}):R&&R.map(((e,t)=>{var o,s,d;const C=e.id===(null==l?void 0:l.length)-1;return(0,g.jsx)(kl,(0,i.Z)({index:null!=(o=e.id)?o:t,selectableKey:e.id,value:e,onChange:l=>T(e.id,l),onRemove:()=>E(e.id),onPersist:()=>{return l=e.id,void(x&&x(l));var l},onReset:()=>{return l=e.id,void(y&&y(l));var l},onBlur:(l,n)=>((e,l,n)=>{w&&w(e,l,n)})(e.id,l,n),disableSorting:n||C,disableToggle:c||C&&!r,disableDelete:a||C,disableVariableRowDropdown:b||C&&!r,keyPlaceholder:C&&u,valuePlaceholder:C&&h,descriptionPlaceholder:C&&p,isLastRow:C,currentWidth:v,maskState:!(!r&&C)&&(f&&f[e.id]||{isMasked:e.type===Q}),isDuplicated:V&&V[e.id].isOverridden,toggleMaskValue:m},S),null!=(s=null==(d=e.id)?void 0:d.toString())?s:t)}))})}var Dl=n(57569);function Al(e,l=100){return e/l*100}function Zl(e,l=2){return Math.round(e*Math.pow(10,l))/Math.pow(10,l)}let Wl;const Ml=500,Fl=s().div(Wl||(Wl=(e=>e)`
  height: 32px;
  width: 16px;
  margin-left: -8px;
  background-color: transparent;
