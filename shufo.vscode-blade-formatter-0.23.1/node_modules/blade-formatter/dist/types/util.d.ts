...
export declare function prettifyPhpContentWithUnescapedTags(content: string, options: FormatPhpOption): Promise<any>;
...
export declare function formatAsPhp(content: string, options: FormatPhpOption): Promise<any>;
